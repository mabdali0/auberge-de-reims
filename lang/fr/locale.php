...
return [
    "dashboards-nav" => "Tableau de bord",
    "statistics-nav" => "Statistiques",
    "reservations-nav" => "Réservations",
    "website-nav" => "Le site web",
    "gallery-nav" => "Galerie photo",
    "our-story-nav" => "Notre histoire",
    "find-us-nav" => "Ou nous trouver",
    "contact-us-nav" => "Nous contacter",
    "book-a-table-nav" => "Réserver une table",
    "menu-nav" => "Le menu",
    "admin-nav" => "Admin",
